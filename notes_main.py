...
list_widget_1.setStyleSheet('background-color: #B47AEA')

list_widget_2 = QListWidget()                                       # Список (Контактні дані)
list_widget_2.setStyleSheet('background-color:#FFEE88;')
...
search_for_text.setStyleSheet('background-color: #F19143')
